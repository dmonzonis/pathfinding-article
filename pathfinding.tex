...
Every node has a latitude and longitude associated given in microdegrees, which represent the geographical coordinates of the node. We use this information to build a weighted graph, giving each edge a weight equal to the great-circle distance %TODO Add cite
computed using Haversine's formula %TODO Add cite
. We will also use this information for the heuristics we will be using.
...
%TODO Conclusions: balance memory efficiency and time efficiency
...
%TODO Conclusions: good to check if a path exists
...
\bibitem{dimacs} 9th DIMACS Implementation Challenge, \url{http://www.dis.uniroma1.it/challenge9/}
